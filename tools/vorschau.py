...
def _galerie(namen_dunkel: list[str], namen_hell: list[str]) -> None:
    """Schreibt docs/vorschau.md und docs/vorschau.de.md, immer ueber alle Themes.
...
def main(argv: list[str]) -> int:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        for name in themes:
            ...
            print(f"[OK] {name}")
    print(f"{len(themes)} Bilder in {ZIEL}, Galerie in docs/vorschau.md und docs/vorschau.de.md")
    return 0
